...
<title>View All Books On Loan</title>
...
<!-- Banner -->
  <div class="admin-banner">
    <div class="admin-banner-info">
        <h1>Here are all the books currently on loan</h1>
    </div>
  </div>
...
<!-- Body -->
  <div class="container mx-auto mt-4" style="height: 80vh">
		<table class="table">
		  ...
		  <tbody>
		  	<% ArrayList<Loan> onLoan = (ArrayList<Loan>)session.getAttribute("onLoan");
				for(Loan l : onLoan) { %>
				<tr>
					<td><%out.println(l.getMemberId());%></td>
					<td><%out.println(l.getMemberName());%></td>
					<td><%out.println(l.getBookId());%></td>
					<td><%out.println(l.getTitle());%></td>
					<td><%out.println(l.getDate());%></td>
					<td><%out.println(l.getDueDate());%></td>
				</tr>	      
			<%} %> 
		  </tbody>
		</table>
